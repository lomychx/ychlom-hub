...
local ArrayFieldLibrary = {
	...
	Theme = {
		Default = {
			...
			SliderBackground = Color3.fromRGB(209,101,33),
			SliderProgress = Color3.fromRGB(209,101,33),
			SliderStroke = Color3.fromRGB(227,111,41),

			ToggleBackground = Color3.fromRGB(16,16,16),
			ToggleEnabled = Color3.fromRGB(217,99,27),
			ToggleDisabled = Color3.fromRGB(16,16,16),
			ToggleEnabledStroke = Color3.fromRGB(46,10,0),
			ToggleDisabledStroke = Color3.fromRGB(28,28,28),
			ToggleEnabledOuterStroke = Color3.fromRGB(100, 100, 100),
			ToggleDisabledOuterStroke = Color3.fromRGB(65, 65, 65),

			InputBackground = Color3.fromRGB(16,16,16),
			InputStroke = Color3.fromRGB(34,34,34),
...
local ArrayField = game:GetObjects("rbxassetid://14106968499")[1]
...
local Titlebar = Main.SideTabList.Titlebar
...
function CloseSideBar()
	...
	TweenService:Create(Main.SideTabList, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
    TweenService:Create(Main.SideTabList.Titlebar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
	TweenService:Create(Main.SideTabList.Titlebar.Divider, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
    TweenService:Create(Main.SideTabList.Titlebar.CornerRepair, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
    TweenService:Create(Main.SideTabList.Titlebar.Title, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {TextTransparency = 1}):Play()
    wait(.4)
...
function Hide()
	...
	Debounce = true
	ArrayFieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping Delete", Duration = 7})
...
function OpenSettings()
    ...
    TweenService:Create(Main.Settings, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.5}):Play()

    TweenService:Create(Main.Settings.Prompt, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
    TweenService:Create(Main.Settings.Prompt.Title, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {TextTransparency = 0}):Play()

    TweenService:Create(Main.Settings.Prompt.Titlebar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
    TweenService:Create(Main.Settings.Prompt.Titlebar.CornerRepair, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
    TweenService:Create(Main.Settings.Prompt.Titlebar.Divider, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
    TweenService:Create(Main.Settings.Prompt.Titlebar.Title, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {TextTransparency = 0}):Play()
    TweenService:Create(Main.Settings.Prompt.Titlebar.Hide, TweenInfo.new(0.5, Enum.EasingStyle.Quint),{ImageTransparency = 0.5}):Play()
    TweenService:Create(Main.Settings.Prompt.Titlebar.Settings, TweenInfo.new(0.5, Enum.EasingStyle.Quint),{ImageTransparency = 0}):Play()
end

function HideSettings()
    SettingsOpened = false

    TweenService:Create(Main.Settings, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()

    TweenService:Create(Main.Settings.Prompt, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
    TweenService:Create(Main.Settings.Prompt.Title, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {TextTransparency = 1}):Play()

    TweenService:Create(Main.Settings.Prompt.Titlebar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
    TweenService:Create(Main.Settings.Prompt.Titlebar.CornerRepair, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
    TweenService:Create(Main.Settings.Prompt.Titlebar.Divider, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
    TweenService:Create(Main.Settings.Prompt.Titlebar.Title, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {TextTransparency = 1}):Play()
    TweenService:Create(Main.Settings.Prompt.Titlebar.Hide, TweenInfo.new(0.5, Enum.EasingStyle.Quint),{ImageTransparency = 1}):Play()
    TweenService:Create(Main.Settings.Prompt.Titlebar.Settings, TweenInfo.new(0.5, Enum.EasingStyle.Quint),{ImageTransparency = 1}):Play()
...
function OpenSideBar()
	...
	TweenService:Create(Main.SideTabList, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.03}):Play()

    TweenService:Create(Main.SideTabList.Titlebar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
	TweenService:Create(Main.SideTabList.Titlebar.Divider, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
    TweenService:Create(Main.SideTabList.Titlebar.CornerRepair, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
    TweenService:Create(Main.SideTabList.Titlebar.Title, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {TextTransparency = 0}):Play()
...
function ArrayFieldLibrary:CreateWindow(Settings)
	...
	Titlebar.Title.Text = Settings.Name
	...
	if Settings.KeySystem then
		...
		if not Passthrough then
			...
			KeyUI.Main.Input.InputBox.FocusLost:Connect(function(EnterPressed)
                ...
                if Settings.KeySettings.KeyVerification.Enabled then
                    local Success, Response = pcall(function()
                        local isvaild = Settings.KeySettings.KeyVerification.IsValidKey(KeyMain.Input.InputBox.Text)
                    ...
                    if not Success then
                        print("ArrayField | KeyVerification Callback Error " ..tostring(Response))
                    end
                else
	...
	function Window:CreateTab(Name,Image)
		...
		if FirstTab then
			...
			TweenService:Create(SideTabButton.Image, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageTransparency = 0,ImageColor3 = Color3.fromRGB(71,71,71)}):Play()
			TweenService:Create(SideTabButton.Title, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {TextTransparency = .2,TextColor3 = Color3.fromRGB(71,71,71)}):Play()	
		else
			FirstTab = Name
			...
			SideTabButton.Image.ImageColor3 = Color3.fromRGB(190, 105, 67)
			SideTabButton.Title.TextColor3 = Color3.fromRGB(190, 105, 67)
            ...
            Topbar.Type.Image = SideTabButton.Image.Image
            Topbar.Title.Text = SideTabButton.Title.Text
		end
		...
		local function Pick()
			...
			TweenService:Create(SideTabButton.Image, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageTransparency = 0,ImageColor3 = Color3.fromRGB(190, 105, 67)}):Play()
			TweenService:Create(SideTabButton.Title, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {TextTransparency = 0,TextColor3 = Color3.fromRGB(190, 105, 67)}):Play()
			...
			for _,OtherTabButton in ipairs(SideList:GetChildren()) do
				spawn(function()
					if OtherTabButton.Name ~= "Template" and OtherTabButton.ClassName == "Frame" and OtherTabButton ~= SideTabButton and OtherTabButton.Name ~= "Placeholder" then
						TweenService:Create(OtherTabButton.Image, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageTransparency = 0,ImageColor3 = Color3.fromRGB(71,71,71)}):Play()
						TweenService:Create(OtherTabButton.Title, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {TextTransparency = .2,TextColor3 = Color3.fromRGB(71,71,71)}):Play()	
					end
				end)
			end
		...
		function Tab:CreateKeybind(KeybindSettings)
			...
			UserInputService.InputBegan:Connect(function(input, processed)
				...
				if CheckingForKey then
					if input.KeyCode ~= Enum.KeyCode.Unknown and input.KeyCode ~= Enum.KeyCode.Delete then
